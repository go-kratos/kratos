...
type ByeReply struct {
	...
	Body *ByeReply_Body `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty"`
}
...
func (x *ByeReply) GetBody() *ByeReply_Body {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *ByeReply_Body) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ByeReply_Body) ProtoMessage() {}

func (x *ByeReply_Body) ProtoReflect() protoreflect.Message {
	mi := &file_helloworld_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ByeReply_Body.ProtoReflect.Descriptor instead.
func (*ByeReply_Body) Descriptor() ([]byte, []int) {
	return file_helloworld_proto_rawDescGZIP(), []int{3, 0}
}

func (x *ByeReply_Body) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x5b, 0x0a, 0x08, 0x42, 0x79,
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x2d, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c,
	0x64, 0x2e, 0x42, 0x79, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x2e, 0x42, 0x6f, 0x64, 0x79, 0x52,
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x1a, 0x20, 0x0a, 0x04, 0x42, 0x6f, 0x64, 0x79, 0x12, 0x18, 0x0a,
	...
	0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x12, 0x54, 0x0a,
	0x06, 0x53, 0x61, 0x79, 0x42, 0x79, 0x65, 0x12, 0x16, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77,
	0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x42, 0x79, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x14, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x42, 0x79, 0x65,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x1c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x16, 0x12, 0x0e, 0x2f,
	0x73, 0x61, 0x79, 0x62, 0x79, 0x65, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x62, 0x04, 0x62,
...
var file_helloworld_proto_goTypes = []interface{}{
	...
	(*ByeReply_Body)(nil), // 4: helloworld.ByeReply.Body
}
var file_helloworld_proto_depIdxs = []int32{
	4, // 0: helloworld.ByeReply.body:type_name -> helloworld.ByeReply.Body
	...
	3, // 4: helloworld.Greeter.SayBye:output_type -> helloworld.ByeReply
