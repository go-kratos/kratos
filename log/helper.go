...
func (h *Helper) Debug(a ...interface{}) {
	h.logger.Log(LevelDebug, h.msgKey, fmt.Sprint(a...))
}
...
func (h *Helper) Info(a ...interface{}) {
	h.logger.Log(LevelInfo, h.msgKey, fmt.Sprint(a...))
}
...
func (h *Helper) Warn(a ...interface{}) {
	h.logger.Log(LevelWarn, h.msgKey, fmt.Sprint(a...))
}
...
func (h *Helper) Error(a ...interface{}) {
	h.logger.Log(LevelError, h.msgKey, fmt.Sprint(a...))
}
...
func (h *Helper) Fatal(a ...interface{}) {
	h.logger.Log(LevelFatal, h.msgKey, fmt.Sprint(a...))
	os.Exit(1)
}
