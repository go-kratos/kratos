...
func (h *Helper) Debug(a ...interface{}) {
	if h.opts.level.Enabled(LevelDebug) {
		h.Print(LevelDebug, "log", fmt.Sprint(a...))
	}
}
...
func (h *Helper) Debugf(format string, a ...interface{}) {
	if h.opts.level.Enabled(LevelDebug) {
		h.Print(LevelDebug, "log", fmt.Sprintf(format, a...))
	}
}
...
func (h *Helper) Info(a ...interface{}) {
	if h.opts.level.Enabled(LevelInfo) {
		h.Print(LevelInfo, "log", fmt.Sprint(a...))
	}
}
...
func (h *Helper) Infof(format string, a ...interface{}) {
	if h.opts.level.Enabled(LevelInfo) {
		h.Print(LevelInfo, "log", fmt.Sprintf(format, a...))
	}
}
...
func (h *Helper) Warn(a ...interface{}) {
	if h.opts.level.Enabled(LevelWarn) {
		h.Print(LevelWarn, "log", fmt.Sprint(a...))
	}
}
...
func (h *Helper) Warnf(format string, a ...interface{}) {
	if h.opts.level.Enabled(LevelWarn) {
		h.Print(LevelWarn, "log", fmt.Sprintf(format, a...))
	}
}
...
func (h *Helper) Error(a ...interface{}) {
	if h.opts.level.Enabled(LevelError) {
		h.Print(LevelError, "log", fmt.Sprint(a...))
	}
}
...
func (h *Helper) Errorf(format string, a ...interface{}) {
	if h.opts.level.Enabled(LevelError) {
		h.Print(LevelError, "log", fmt.Sprintf(format, a...))
	}
}
