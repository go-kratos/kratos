...
func (f *fakeNamingClient) BatchRegisterInstance(arg0 vo.BatchRegisterInstanceParam) (bool, error) {
    return true, nil
}
func (f *fakeNamingClient) CloseClient() {}
func (f *fakeNamingClient) GetAllServicesInfo(arg0 vo.GetAllServiceInfoParam) (model.ServiceList, error) {
    return model.ServiceList{}, nil
}
func (f *fakeNamingClient) SelectAllInstances(arg0 vo.SelectAllInstancesParam) ([]model.Instance, error) {
    return nil, nil
}
...
func (f *fakeNamingClient) UpdateInstance(arg0 vo.UpdateInstanceParam) (bool, error) { return true, nil }
