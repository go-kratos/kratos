...
func WithPrefix(prefix string) RegistryOption {
	return func(o *registryOptions) { o.prefix = prefix }
}

// WithWeight with weight option.
func WithWeight(weight float64) RegistryOption {
	return func(o *registryOptions) { o.weight = weight }
}

// WithCluster with cluster option.
func WithCluster(cluster string) RegistryOption {
...
func WithDefaultKind(kind string) RegistryOption {
	return func(o *registryOptions) { o.kind = kind }
}
...
func NewRegistry(cli naming_client.INamingClient, opts ...RegistryOption) (r *Registry) {
	op := registryOptions{
...
func (r *Registry) Watch(ctx context.Context, serviceName string) (registry.Watcher, error) {
	return newSubscriber(ctx, r.cli, serviceName, r.opts.group, r.opts.kind, []string{r.opts.cluster})
}
