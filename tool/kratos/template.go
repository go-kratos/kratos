...
`
	_tplAPIGenerate = `// +build !windows

package api

// 运行: go generate
// 自动生成gRPC API源码，如果没安装gogofast插件将会自动安装
// 需要手动安装protobuf：https://github.com/protocolbuffers/protobuf
//go:generate env GO111MODULE=off go get -v github.com/gogo/protobuf/protoc-gen-gogofast
//go:generate protoc --proto_path=$GOPATH/src:. --gogofast_out=plugins=grpc:. api.proto
`
	_tplAPIGenerateWin = `package api

// 运行: go generate
// 自动生成gRPC API源码，如果没安装gogofast插件将会自动安装
// 需要手动安装protobuf：https://github.com/protocolbuffers/protobuf
//go:generate set GO111MODULE=off go get -v github.com/gogo/protobuf/protoc-gen-gogofast
//go:generate protoc --proto_path=%GOPATH%\src --proto_path=%cd% --gogofast_out=plugins=grpc:. api.proto
`
