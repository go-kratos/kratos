...
func NewBuilder(d registry.Discovery, opts ...Option) *builder {
	b := &builder{
		discoverer: d,
...
func (b *builder) Build(target resolver.Target, cc client.MultipleServersDiscovery, opts resolver.BuildOptions) (resolver.Resolver, error) {
	var (
		err error
		w   registry.Watcher
	)
