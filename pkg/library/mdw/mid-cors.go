...
func CORS(allowOriginHosts []string) bm.HandlerFunc {
	config := &CORSConfig{
...
func newCORS(config *CORSConfig) bm.HandlerFunc {
...
func (cors *cors) applyCORS(c *bm.Context) {
...
func (cors *cors) handlePreflight(c *bm.Context) {
	header := c.Writer.Header()
...
func (cors *cors) handleNormal(c *bm.Context) {
	header := c.Writer.Header()
