...
type JoinTableHandlerInterface interface {
	...
	Add(ctx context.Context, handler JoinTableHandlerInterface, db *DB, source interface{}, destination interface{}) error
	// Delete delete relationship in join table for sources
	Delete(ctx context.Context, handler JoinTableHandlerInterface, db *DB, sources ...interface{}) error
...
// Add create relationship in join table for source and destination
func (s JoinTableHandler) Add(ctx context.Context, handler JoinTableHandlerInterface, db *DB, source interface{}, destination interface{}) error {
	var (
		scope        = db.NewScope("")
	...
	return db.Exec(ctx, sql, values...).Error
}

// Delete delete relationship in join table for sources
func (s JoinTableHandler) Delete(ctx context.Context, handler JoinTableHandlerInterface, db *DB, sources ...interface{}) error {
	var (
	...
	return db.Table(handler.Table(db)).Where(strings.Join(conditions, " AND "), values...).Delete(ctx, "").Error
}
