...
func (scope *Scope) handleHasOnePreload(field *Field, conditions []interface{}) {
	...
	scope.Err(preloadDB.Where(query, values...).Find(scope.C, results, preloadConditions...).Error)
...
func (scope *Scope) handleBelongsToPreload(field *Field, conditions []interface{}) {
	...
	// find relations
	results := makeSlice(field.Struct.Type)
	scope.Err(preloadDB.Where(fmt.Sprintf("%v IN (%v)", toQueryCondition(scope, relation.AssociationForeignDBNames), toQueryMarks(primaryKeys)), toQueryValues(primaryKeys)...).Find(scope.C, results, preloadConditions...).Error)
...
func (scope *Scope) handleManyToManyPreload(field *Field, conditions []interface{}) {
	...
	rows, err := preloadDB.Rows(scope.C)
