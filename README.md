...
* GRPC Warden：基于官方gRPC开发，集成[discovery](https://github.com/bilibili/discovery)进行服务发现，并融合P2C负载均衡；
...
* Trace：基于opentracing，全链路集成了trace支持（gRPC/HTTP/MySQL/Redis/Memcached）；
* Kratos Tool：构架工具链，可快速生成标准项目，或者通过Protobuf生成代码，非常便捷使用gRPC、HTTP、swagger以及文档输出；
