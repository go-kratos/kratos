...
- You can define [verification rules]([examples/validate](https://go-kratos.dev/en/docs/component/middleware/validate)) in Protobuf which is supported by HTTP/gRPC service.
